...
public class ReportTestManager {
    ...
    private static ExtentReports report = ReportManager.getInstance();
    private static ExtentReports updateReport = ReportManager.getInstance();
    ...
    public static synchronized ExtentTest startTest(String className,String testName, String desc) {
        ...
        map.put((int) (long) (Thread.currentThread().getId()), test);
        return test;
    }
